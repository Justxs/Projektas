...
<form action="include/proclogin.php" method="POST" class="login">
    ...
    <div class="form-group">
        ...
        <input class="form-control mb-3" name="user" required placeholder="Slapyvardis" type="text" oninvalid="this.setCustomValidity('Įveskite vartotojo slapyvardį')" oninput="this.setCustomValidity('')" />

        <label>Slaptažodis:</label>
        <input class="form-control mb-3" name="pass" required placeholder="Slaptažodis" type="password" oninvalid="this.setCustomValidity('Įveskite slaptažodį')" oninput="this.setCustomValidity('')" />
